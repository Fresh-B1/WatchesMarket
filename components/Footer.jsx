    ...
    <footer>
      <div id="footer" className="footer_container">
        <div className="footer_inner_1">
          ...
          <a href=""><p>FAQ</p></a>
          <a href=""><p>Гарантия</p></a>
        </div>

        <div className="footer_inner_2">
          <h3>Информация о компании</h3>
          <a href=""><p>Пресса</p></a>
          <a href=""><p>Работа в IN-Time</p></a>
          <a href=""><p>Политика Конфиденциальности</p></a>
        </div>

        <div className="footer_inner_3">
          <h3>Способы оплаты</h3>
          <a href="/"><img className="payments master" src="./img/payment/Mastercard_footer.avif" alt="" /></a>
          <a href="/"><img className="payments visa" src="./img/payment/Visa_footer.webp" alt="" /></a>
